...
func main() {
	...
	// world.Add(&hit.Shpere{Center: *vec.New(0, -1000, 0), Radius: 1000, Material: ground_material})
	...
	// 				world.Add(hit.Shpere{Center: *center, Radius: 0.2, Material: sphere_material})
	...
	// world.Add(hit.Shpere{Center: *vec.New(0.0, 1, 0), Radius: 1.0, Material: material1})

	// material2 := &hit.Lambertian{Albedo: *vec.New(0.4, 0.2, 0.1)}
	// world.Add(hit.Shpere{Center: *vec.New(-4, 1, 0), Radius: 1.0, Material: material2})

	// material3 := &hit.Metal{Albedo: *vec.New(0.7, 0.6, 0.5), Fuzz: 0.0}
	// world.Add(hit.Shpere{Center: *vec.New(4, 1, 0), Radius: 1.0, Material: material3})
