...
func main() {
	...
	dielec := &hit.Dielectric{RefractIndex: 1.5}
	...
	// world.Add(hit.Shpere{Center: *vec.New(0.0, 0.0, -.5), Radius: 0.2, Material: dielec})
	// world.Add(hit.Shpere{Center: *vec.New(-1.0, 0.0, -1.0), Radius: 0.5, Material: material_left})
	world.Add(hit.Shpere{Center: *vec.New(-1.0, 0.0, -1.0), Radius: 0.5, Material: dielec})
